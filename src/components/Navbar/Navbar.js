    ...
    return (
        <div className='navbar'>
            <div className='container'>
                ...
                <button className='btn' style={{ cursor: "pointer", color: "white" }} onClick={() => GetScreen("Sign_in")} >Sign In</button>
                <div className='hamburger' onClick={handleClick} style={{ color: "white" }}>
